...
proc create_root_design { parentCell } {
  ...
  set x [ create_bd_port -dir I -from 31 -to 0 -type data x ]
  set y [ create_bd_port -dir O -from 31 -to 0 -type data y ]
  set y_ap_vld [ create_bd_port -dir O y_ap_vld ]

  # Create instance: hls_inst, and set properties
  set hls_inst [ create_bd_cell -type ip -vlnv xilinx.com:hls:fir:1.0 hls_inst ]
  ...
  connect_bd_net -net hls_inst_y [get_bd_ports y] [get_bd_pins hls_inst/y]
  connect_bd_net -net hls_inst_y_ap_vld [get_bd_ports y_ap_vld] [get_bd_pins hls_inst/y_ap_vld]
  connect_bd_net -net x_0_1 [get_bd_ports x] [get_bd_pins hls_inst/x]
