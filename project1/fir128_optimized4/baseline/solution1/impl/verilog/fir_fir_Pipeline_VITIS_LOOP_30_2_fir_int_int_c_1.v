...
// ==============================================================
`timescale 1 ns / 1 ps
module fir_fir_Pipeline_VITIS_LOOP_30_2_fir_int_int_c_1 (
...
initial begin
    $readmemh("./fir_fir_Pipeline_VITIS_LOOP_30_2_fir_int_int_c_1.dat", ram0);
    $readmemh("./fir_fir_Pipeline_VITIS_LOOP_30_2_fir_int_int_c_1.dat", ram1);
end
