...
// ==============================================================
`timescale 1 ns / 1 ps
module fir_fir_Pipeline_VITIS_LOOP_30_2_fir_int_int_c_3 (
...
initial begin
    $readmemh("./fir_fir_Pipeline_VITIS_LOOP_30_2_fir_int_int_c_3.dat", ram0);
    $readmemh("./fir_fir_Pipeline_VITIS_LOOP_30_2_fir_int_int_c_3.dat", ram1);
    $readmemh("./fir_fir_Pipeline_VITIS_LOOP_30_2_fir_int_int_c_3.dat", ram2);
    $readmemh("./fir_fir_Pipeline_VITIS_LOOP_30_2_fir_int_int_c_3.dat", ram3);
    $readmemh("./fir_fir_Pipeline_VITIS_LOOP_30_2_fir_int_int_c_3.dat", ram4);
    $readmemh("./fir_fir_Pipeline_VITIS_LOOP_30_2_fir_int_int_c_3.dat", ram5);
    $readmemh("./fir_fir_Pipeline_VITIS_LOOP_30_2_fir_int_int_c_3.dat", ram6);
    $readmemh("./fir_fir_Pipeline_VITIS_LOOP_30_2_fir_int_int_c_3.dat", ram7);
end
