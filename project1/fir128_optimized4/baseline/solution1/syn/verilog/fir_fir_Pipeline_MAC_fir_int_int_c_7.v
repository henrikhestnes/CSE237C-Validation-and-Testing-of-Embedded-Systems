...
// ==============================================================
`timescale 1 ns / 1 ps
module fir_fir_Pipeline_MAC_fir_int_int_c_7 (
...
initial begin
    $readmemh("./fir_fir_Pipeline_MAC_fir_int_int_c_7.dat", ram0);
    $readmemh("./fir_fir_Pipeline_MAC_fir_int_int_c_7.dat", ram1);
    $readmemh("./fir_fir_Pipeline_MAC_fir_int_int_c_7.dat", ram2);
    $readmemh("./fir_fir_Pipeline_MAC_fir_int_int_c_7.dat", ram3);
    $readmemh("./fir_fir_Pipeline_MAC_fir_int_int_c_7.dat", ram4);
    $readmemh("./fir_fir_Pipeline_MAC_fir_int_int_c_7.dat", ram5);
    $readmemh("./fir_fir_Pipeline_MAC_fir_int_int_c_7.dat", ram6);
    $readmemh("./fir_fir_Pipeline_MAC_fir_int_int_c_7.dat", ram7);
end
