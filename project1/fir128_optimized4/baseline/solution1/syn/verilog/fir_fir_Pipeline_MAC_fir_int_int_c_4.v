...
// ==============================================================
`timescale 1 ns / 1 ps
module fir_fir_Pipeline_MAC_fir_int_int_c_4 (
...
initial begin
    $readmemh("./fir_fir_Pipeline_MAC_fir_int_int_c_4.dat", ram0);
    $readmemh("./fir_fir_Pipeline_MAC_fir_int_int_c_4.dat", ram1);
    $readmemh("./fir_fir_Pipeline_MAC_fir_int_int_c_4.dat", ram2);
    $readmemh("./fir_fir_Pipeline_MAC_fir_int_int_c_4.dat", ram3);
    $readmemh("./fir_fir_Pipeline_MAC_fir_int_int_c_4.dat", ram4);
    $readmemh("./fir_fir_Pipeline_MAC_fir_int_int_c_4.dat", ram5);
    $readmemh("./fir_fir_Pipeline_MAC_fir_int_int_c_4.dat", ram6);
    $readmemh("./fir_fir_Pipeline_MAC_fir_int_int_c_4.dat", ram7);
end
