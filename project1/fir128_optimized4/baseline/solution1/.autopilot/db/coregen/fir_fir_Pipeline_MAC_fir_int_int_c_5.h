...
// ==============================================================
#ifndef __fir_fir_Pipeline_MAC_fir_int_int_c_5_H__
#define __fir_fir_Pipeline_MAC_fir_int_int_c_5_H__
...
struct fir_fir_Pipeline_MAC_fir_int_int_c_5_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(fir_fir_Pipeline_MAC_fir_int_int_c_5_ram) {
        ram[0] = "0b11111111111111111111111111111101";
...
SC_MODULE(fir_fir_Pipeline_MAC_fir_int_int_c_5) {
...
fir_fir_Pipeline_MAC_fir_int_int_c_5_ram* meminst;


SC_CTOR(fir_fir_Pipeline_MAC_fir_int_int_c_5) {
meminst = new fir_fir_Pipeline_MAC_fir_int_int_c_5_ram("fir_fir_Pipeline_MAC_fir_int_int_c_5_ram");
