...
(* ram_style = "block" *)reg [DataWidth-1:0] ram3[0:AddressRange-1];
(* ram_style = "block" *)reg [DataWidth-1:0] ram4[0:AddressRange-1];
(* ram_style = "block" *)reg [DataWidth-1:0] ram5[0:AddressRange-1];
(* ram_style = "block" *)reg [DataWidth-1:0] ram6[0:AddressRange-1];
(* ram_style = "block" *)reg [DataWidth-1:0] ram7[0:AddressRange-1];
(* ram_style = "block" *)reg [DataWidth-1:0] ram8[0:AddressRange-1];
(* ram_style = "block" *)reg [DataWidth-1:0] ram9[0:AddressRange-1];
(* ram_style = "block" *)reg [DataWidth-1:0] ram10[0:AddressRange-1];
(* ram_style = "block" *)reg [DataWidth-1:0] ram11[0:AddressRange-1];
(* ram_style = "block" *)reg [DataWidth-1:0] ram12[0:AddressRange-1];
(* ram_style = "block" *)reg [DataWidth-1:0] ram13[0:AddressRange-1];
(* ram_style = "block" *)reg [DataWidth-1:0] ram14[0:AddressRange-1];
(* ram_style = "block" *)reg [DataWidth-1:0] ram15[0:AddressRange-1];
(* ram_style = "block" *)reg [DataWidth-1:0] ram16[0:AddressRange-1];
(* ram_style = "block" *)reg [DataWidth-1:0] ram17[0:AddressRange-1];
(* ram_style = "block" *)reg [DataWidth-1:0] ram18[0:AddressRange-1];
(* ram_style = "block" *)reg [DataWidth-1:0] ram19[0:AddressRange-1];
(* ram_style = "block" *)reg [DataWidth-1:0] ram20[0:AddressRange-1];
(* ram_style = "block" *)reg [DataWidth-1:0] ram21[0:AddressRange-1];
(* ram_style = "block" *)reg [DataWidth-1:0] ram22[0:AddressRange-1];
(* ram_style = "block" *)reg [DataWidth-1:0] ram23[0:AddressRange-1];
(* ram_style = "block" *)reg [DataWidth-1:0] ram24[0:AddressRange-1];
(* ram_style = "block" *)reg [DataWidth-1:0] ram25[0:AddressRange-1];
(* ram_style = "block" *)reg [DataWidth-1:0] ram26[0:AddressRange-1];
(* ram_style = "block" *)reg [DataWidth-1:0] ram27[0:AddressRange-1];
(* ram_style = "block" *)reg [DataWidth-1:0] ram28[0:AddressRange-1];
(* ram_style = "block" *)reg [DataWidth-1:0] ram29[0:AddressRange-1];
(* ram_style = "block" *)reg [DataWidth-1:0] ram30[0:AddressRange-1];
(* ram_style = "block" *)reg [DataWidth-1:0] ram31[0:AddressRange-1];
(* ram_style = "block" *)reg [DataWidth-1:0] ram32[0:AddressRange-1];
(* ram_style = "block" *)reg [DataWidth-1:0] ram33[0:AddressRange-1];

initial begin
    $readmemh("./fir_c.dat", ram0);
    $readmemh("./fir_c.dat", ram1);
    $readmemh("./fir_c.dat", ram2);
    $readmemh("./fir_c.dat", ram3);
    $readmemh("./fir_c.dat", ram4);
    $readmemh("./fir_c.dat", ram5);
    $readmemh("./fir_c.dat", ram6);
    $readmemh("./fir_c.dat", ram7);
    $readmemh("./fir_c.dat", ram8);
    $readmemh("./fir_c.dat", ram9);
    $readmemh("./fir_c.dat", ram10);
    $readmemh("./fir_c.dat", ram11);
    $readmemh("./fir_c.dat", ram12);
    $readmemh("./fir_c.dat", ram13);
    $readmemh("./fir_c.dat", ram14);
    $readmemh("./fir_c.dat", ram15);
    $readmemh("./fir_c.dat", ram16);
    $readmemh("./fir_c.dat", ram17);
    $readmemh("./fir_c.dat", ram18);
    $readmemh("./fir_c.dat", ram19);
    $readmemh("./fir_c.dat", ram20);
    $readmemh("./fir_c.dat", ram21);
    $readmemh("./fir_c.dat", ram22);
    $readmemh("./fir_c.dat", ram23);
    $readmemh("./fir_c.dat", ram24);
    $readmemh("./fir_c.dat", ram25);
    $readmemh("./fir_c.dat", ram26);
    $readmemh("./fir_c.dat", ram27);
    $readmemh("./fir_c.dat", ram28);
    $readmemh("./fir_c.dat", ram29);
    $readmemh("./fir_c.dat", ram30);
    $readmemh("./fir_c.dat", ram31);
    $readmemh("./fir_c.dat", ram32);
    $readmemh("./fir_c.dat", ram33);
end
