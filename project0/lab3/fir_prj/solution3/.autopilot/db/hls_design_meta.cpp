...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("c_address1", 4, hls_out, 1, "ap_memory", "MemPortADDR2", 1),
	Port_Property("c_ce1", 1, hls_out, 1, "ap_memory", "MemPortCE2", 1),
	Port_Property("c_q1", 32, hls_in, 1, "ap_memory", "MemPortDOUT2", 1),
	Port_Property("x", 32, hls_in, 2, "ap_vld", "in_data", 1),
	Port_Property("x_ap_vld", 1, hls_in, 2, "ap_vld", "in_vld", 1),
};
