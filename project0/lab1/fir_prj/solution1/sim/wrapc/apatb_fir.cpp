...
#define AUTOTB_TVOUT_c "../tv/cdatafile/c.fir.autotvout_c.dat"
// wrapc file define:
...
// tvout file define:
#define AUTOTB_TVOUT_PC_c "../tv/rtldatafile/rtl.fir.autotvout_c.dat"
// tvout file define:
...
extern "C" void fir_hw_stub_wrapper(volatile void *, volatile void *, int);

extern "C" void apatb_fir_hw(volatile void * __xlx_apatb_param_y, volatile void * __xlx_apatb_param_c, int __xlx_apatb_param_x) {
...
fir_hw_stub_wrapper(__xlx_apatb_param_y, __xlx_apatb_param_c, __xlx_apatb_param_x);
...
// print y Transactions
{
  ...
  aesl_fh.write(AUTOTB_TVOUT_y, __xlx_sprintf_buffer.data());
  {
    ...
    std::string s(__xlx_tmp_lv.to_string(SC_HEX));
    aesl_fh.write(AUTOTB_TVOUT_y, s.append("\n")); 
  }
  tcl_file.set_num(1, &tcl_file.y_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVOUT_y, __xlx_sprintf_buffer.data());
