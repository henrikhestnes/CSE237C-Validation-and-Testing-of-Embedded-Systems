...
int main()
{
	...
	// Test 3
	run_test(-0.5469, -0.9575, 4.193434090081573/*-2.089751217098013*/, 1.102681214132172);
	...
	// Test 6
	run_test(-1, 1, 2.35619449, 1.414213562);

	// Test 7
	run_test(-3, -3, 3.926990817, 4.242640687);

	// Test 8
	run_test(0, -1, -1.570796327, 1);
