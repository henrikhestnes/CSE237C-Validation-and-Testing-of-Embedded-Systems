...
HD_PWD='/home/henrikhestnes/Documents/CSE-237C-Validation-and-Testing-of-Embedded-Systems/project2/cordic/HLS/cordic_optimized1/cordic_test/cordic_test.runs/design_1_auto_pc_0_synth_1'
cd "$HD_PWD"
