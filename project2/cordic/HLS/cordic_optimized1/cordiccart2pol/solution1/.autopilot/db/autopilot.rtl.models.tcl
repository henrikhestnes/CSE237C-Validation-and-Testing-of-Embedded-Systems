set SynModuleInfo {
  {SRCNAME cordiccart2pol MODELNAME cordiccart2pol RTLNAME cordiccart2pol IS_TOP 1
    SUBMODULES {
      ...
      {MODELNAME cordiccart2pol_mul_mul_14ns_17s_30_4_1 RTLNAME cordiccart2pol_mul_mul_14ns_17s_30_4_1 BINDTYPE op TYPE mul IMPL dsp LATENCY 3 ALLOW_PRAGMA 1}
      ...
      {MODELNAME cordiccart2pol_Kvalues_V RTLNAME cordiccart2pol_Kvalues_V BINDTYPE storage TYPE rom IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
