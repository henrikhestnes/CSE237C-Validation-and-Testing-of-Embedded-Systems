...
// ==============================================================
#ifndef __cordiccart2pol_Kvalues_H__
#define __cordiccart2pol_Kvalues_H__
...
struct cordiccart2pol_Kvalues_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(cordiccart2pol_Kvalues_ram) {
...
SC_MODULE(cordiccart2pol_Kvalues) {
...
cordiccart2pol_Kvalues_ram* meminst;


SC_CTOR(cordiccart2pol_Kvalues) {
meminst = new cordiccart2pol_Kvalues_ram("cordiccart2pol_Kvalues_ram");
