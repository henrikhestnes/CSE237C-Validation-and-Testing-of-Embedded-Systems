...
HD_PWD='/home/henrikhestnes/Documents/CSE-237C-Validation-and-Testing-of-Embedded-Systems/project2/cordic/HLS/cordic_optimized3/cordic_test/cordic_test.runs/impl_1'
cd "$HD_PWD"
