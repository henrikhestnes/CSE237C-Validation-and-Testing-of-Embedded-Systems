...
__attribute__((sdx_kernel("cordiccart2pol", 0))) void cordiccart2pol(data_t x, data_t y, data_t * r, data_t * theta)
{
#pragma HLS INTERFACE s_axilite port=Kvalues bundle=cordic_io
# 12 "cordiccart2pol.cpp"

#pragma HLS INTERFACE s_axilite port=angles bundle=cordic_io
# 12 "cordiccart2pol.cpp"

#pragma HLS INTERFACE s_axilite port=r bundle=cordic_io
# 12 "cordiccart2pol.cpp"

#pragma HLS INTERFACE s_axilite port=theta bundle=cordic_io
# 12 "cordiccart2pol.cpp"

#pragma HLS INTERFACE s_axilite port=x bundle=cordic_io
# 12 "cordiccart2pol.cpp"

#pragma HLS INTERFACE s_axilite port=y bundle=cordic_io
# 12 "cordiccart2pol.cpp"

#pragma HLS TOP name=cordiccart2pol
# 12 "cordiccart2pol.cpp"

#pragma HLS INTERFACE mode=s_axilite port=return bundle=cordic_io
 ...
 *theta = 0;
 ...
 data_t x_temp;
 VITIS_LOOP_23_1: for(int i = 0; i < 16; i++){
  x_temp = x;
  if(y > 0){
   x += y*Kvalues[i];
   y -= x_temp*Kvalues[i];
